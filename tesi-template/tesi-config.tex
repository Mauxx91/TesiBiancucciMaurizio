...
\lstset{
    language=[Visual]C++,
    keywordstyle=\fontfamily{Inconsolata}\color{KeywordColor}, %\bfseries,
    basicstyle=\fontfamily{Inconsolata}\small,
    commentstyle=\fontfamily{Inconsolata}\color{Green},
    numbers=none, %left,%
...
\lstdefinestyle{maurizio-code}{
	language =[Visual]C++,
	commentstyle = \fontfamily{Inconsolata}\color{CommentColor},
	keywordstyle={[2]\fontfamily{Inconsolata}\color{MacroColor}},
	keywordstyle={[3]\fontfamily{Inconsolata}\color{TypeColor}},
	keywordstyle={[4]\fontfamily{Inconsolata}\color{StaticColor}},
	morekeywords={[2]
		META\_BEGIN\_CLASS,
	...
	stringstyle=\fontfamily{Inconsolata}\color{StringColor}
}
