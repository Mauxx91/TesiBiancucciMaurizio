...
\section{Disegno degli scheletri di animazione}
	...
	//Spiegare come funziona una versione base dell'algoritmo di skinning
	//todo screenshot animazione scheletrale\\
	...
	//todo screenshot del Beholder dove attiva e disattiva il disegno dei rider\\
