...
\section{Casi d'uso}
	...
	\subsection{UC 1: Caso d'uso principale}
		...
		\begin{figure}[!h] 
			...
			\caption[XML Editor - UC 1: Caso d'uso principale]{Use Case - UC 1: Caso d'uso principale}
		\end{figure}
	...
	\subsection{UC 1.1: Creazione di un nuovo file XML}
		...
		\begin{figure}[!h] 
			...
			\caption[XML Editor - UC 1.1: Creazione di un nuovo file XML]{Use Case - UC 1.1: Creazione di un nuovo file XML}
		\end{figure}
	...
	\subsection{UC 1.3 Editing del file XML correntemente aperto}
		...
		\begin{figure}[!h] 
			...
			\caption[XML Editor - UC 1.3 Editing del file XML correntemente aperto]{Use Case - UC 1.3 Editing del file XML correntemente aperto}
		\end{figure}
	...
	\subsection{UC 1.3.4 Editing del nodo selezionato}
		...
		\begin{figure}[!h] 
			...
			\caption[XML Editor - UC 1.3.4 Editing del nodo selezionato]{Use Case - UC 1.3.4 Editing del nodo selezionato}
		\end{figure}
	...
	\subsection{UC 1.6 Editing dei file associati}
		...
		\begin{figure}[!h] 
			...
			\caption[XML Editor - UC 1.6 Editing dei file associati]{Use Case - UC 1.6 Editing dei file associati}
		\end{figure}
	...
	\subsection{UC 1.7 Editing delle relazioni}
		...
		\begin{figure}[!h] 
			...
			\caption[XML Editor - UC 1.7 Editing delle relazioni]{Use Case - UC 1.7 Editing delle relazioni}
		\end{figure}
	...
	\subsection{UC 1.11 Visualizzazione del risultato del check sulle relazioni}
		...
		\begin{figure}[!h] 
			...
			\caption[XML Editor - UC 1.11 Visualizzazione del risultato del check sulle relazioni]{Use Case - UC 1.11 Visualizzazione del risultato del check sulle relazioni}
		\end{figure}
...
\begin{center}
	\begin{longtable}{p{4.2cm}!{\color{white}\vrule width 0.5mm}p{6cm}!{\color{white}\vrule width 0.5mm}p{2.5cm}!{\color{white}\vrule width 0.5mm}}
		...
		\hline
		\caption{Requisiti funzionali di XML Editor}
	\end{longtable}
\end{center}
...
\begin{center}
	\begin{longtable}{p{4.2cm}!{\color{white}\vrule width 0.5mm}p{6cm}!{\color{white}\vrule width 0.5mm}p{2.5cm}!{\color{white}\vrule width 0.5mm}}
		...
		\hline
		\caption{Requisiti di qualità di XML Editor}
	\end{longtable}
\end{center}
...
\begin{center}
	\begin{longtable}{p{4.2cm}!{\color{white}\vrule width 0.5mm}p{6cm}!{\color{white}\vrule width 0.5mm}p{2.5cm}!{\color{white}\vrule width 0.5mm}}
		...
		\hline
		\caption{Requisiti di vincolo di XML Editor}
	\end{longtable}
\end{center}
...
\subsection{Core}
	...
	\subsubsection{Classe XmlRelationCheckerCoreImpl}
		La classe \texttt{XmlRelationCheckerCoreImpl} concretizza la base astratta \texttt{XmlRelation-} \texttt{CheckerCoreBase} implementando gli algoritmi che effettuano l'analisi dei file verificando la consistenza delle relazioni.
...
\subsection{Pacchetto view}
	...
	\subsubsection{Classe DialogAssociatedFilesForm}
		La classe \texttt{DialogAssociatedFilesForm} concretizza la base astratta \texttt{DialogAssociated-} \texttt{FilesBase} creando un'interfaccia atta alla gestione dei file associati.
	...
	\subsubsection{Classe DialogEditAttributeNameTagCollapse}
		La classe \texttt{DialogEditAttributeNameTagCollapse} concretizza la base astratta \texttt{Dialog-} \texttt{EditAttributeNameTagCollapseBase} creando un'interfaccia atta alla modifica del filtro sull'attributo da visualizzare nell'albero XML.
	...
	\subsubsection{Classe DialogInputFileNameForm}
		La classe \texttt{DialogInputFileNameForm} concretizza la base astratta \texttt{DialogInputFileName-} \texttt{Base} creando un'interfaccia atta all'inserimento di un percorso ed un nome di file. Offre la possibilità di esplorare il file system per un più agevole inserimento. Questa classe è usata per acquisire il file da dove importare o verso dove esportare le relazioni.
	...
	La classe \texttt{DialogXmlRelationManagementTable} concretizza la base astratta \texttt{DialogXml-} \texttt{RelationManagementBase} creando un'interfaccia atta alla gestione delle relazioni, visualizzate sotto forma tabellare.
	...
	\subsubsection{Classe ViewXmlRelationErrorsTable}
		La classe \texttt{ViewXmlRelationErrorsTable} concretizza la base astratta \texttt{ViewXmlRelation-} \texttt{ErrorsBase} creando un'interfaccia tabellare per la visualizzazione dei risultati sul check delle relazioni.
