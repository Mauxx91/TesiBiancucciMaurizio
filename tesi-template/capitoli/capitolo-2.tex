...
\begin{figure}[t]
	\centering
	\hspace*{-0.05\columnwidth}\includegraphics[width=1.1\columnwidth]{game/perforce.png}
...
\begin{itemize}
	...
	\begin{itemize}
		\item \textbf{variabili e parametri}: iniziano sempre in minuscolo e usano una lettera maiuscola per ogni parola (esempio: \texttt{m\_parentWidget}, \texttt{returnValue});
