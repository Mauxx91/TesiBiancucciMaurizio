...
\section{Casi d'uso}
	...
	\subsection{UC 1: Caso d'uso principale}
		...
		\begin{figure}[h!] 
			\centering 
			\includegraphics[width=0.7\columnwidth]{tool1/UC1.png} 
			\caption[Multiplatform File Analyzer - UC 1: Caso d'uso principale]{Use Case - UC 1: Caso d'uso principale}
		\end{figure}
	...
	\subsection{UC 1.1: Analisi dei file di un gioco multipiattaforma}
		...
		\begin{figure}[h!] 
			...
			\caption[Multiplatform File Analyzer - UC 1.1: Analisi dei file di un gioco multipiattaforma]{Use Case - UC 1.1: Analisi dei file di un gioco multipiattaforma}
		\end{figure}
	...
	\subsection{UC 1.1.1: Inserimento dei dati in input all'analisi}
		...
		\begin{figure}[t] 
			...
			\caption[Multiplatform File Analyzer - UC 1.1.1: Inserimento dei dati in input all'analisi]{Use Case - UC 1.1.1: Inserimento dei dati in input all'analisi}
		\end{figure}
	...
	\subsection{UC 1.1.4 Visualizzazione dei risultati dell'analisi}
		...
		\begin{figure}[h!] 
			\centering 
			\includegraphics[width=0.8\columnwidth]{tool1/UC1-1-4.png} 
			\caption[Multiplatform File Analyzer - UC 1.1.4: Visualizzazione dei risultati dell'analisi]{Use Case - UC 1.1.4: Visualizzazione dei risultati dell'analisi}
		\end{figure}
...
\section{Progettazione}
	...
	\subsection{Diagramma delle classi}
		...
		\begin{figure}[p] 
			\centering
			\hspace*{-0.0375\columnwidth}\includegraphics[width=1.075\columnwidth]{tool1/Tool-1-Diagramma-Classi.png} 
...
\section{Uso pratico}
	...
	\begin{figure}[!h] 
		\centering 
		\includegraphics[width=1.0\columnwidth]{tool1/mfaErrorePath.png} 
	...
	\begin{figure}[!h] 
		\centering 
		\includegraphics[width=1.0\columnwidth]{tool1/mfaRisultato.png} 
