...
\usepackage{url}						% per spezzare gli url se troppo lunghi
...
\usepackage[backend=bibtex,style=alphabetic,hyperref,backref]{biblatex}
...
\usepackage[a4paper, top = 3.5cm, bottom = 3cm, left = 4.5cm, right = 3.5cm]{geometry}

\usepackage{fancyhdr}                   % header personalizzati

\usepackage{inconsolata}

\input{tesi-dati}                       % dati personali per identificare l'autore
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.5\columnwidth]{immagini/VerticalAndHorizontalSlice}
	\caption{Rappresentazione grafica di vertical e horizontal slice}
	\label{fig:VerticalAndHorizontalSlice}
\end{figure}
